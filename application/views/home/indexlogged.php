...
<body>
    <div class="cover" data-stellar-background-ratio="0.5">
        ...
        <div id="About-Artisan" class="text-center">
            <div class="jumbotron jumbotron-fluid aos-init aos-animate" data-aos="fade-up" data-aos-duration="1000" data-aos-anchor-placement="top-bottom" data-aos-once="true">
                <h2 class="heading" style="margin-bottom: 100px;"><b>MENU</b></h2>
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-md-4">
                            <div class="card-1">
                                <a href="<?= base_url('home/reqbimbingan'); ?>">
                                    <img src="../assets/img/bg/req.png" class="card-img-top" alt="..." style=" width: 100px; height: 100px;">
                                    <div>
                        ...
                        <div class="col-md-4">
                            <div class="card-1">
                                <a href="<?= base_url('home/history'); ?>">
                                    <img src="../assets/img/bg/history.png" class="card-img-top" alt="..." style=" width: 100px; height: 100px;">
                                    <div>
                        ...
                        <div class="col-md-4">
                            <div class="card-1">
                                <a href="<?= base_url('home/infokurikulum'); ?>">
                                    <img src="../assets/img/bg/info.png" class="card-img-top" alt="..." style=" width: 100px; height: 100px;">
                                    <div>
